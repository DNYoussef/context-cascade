/*============================================================================*/
/* REVERSE-ENGINEERING-DEEP-ANALYSIS SKILL :: VERILINGUA x VERIX EDITION                      */
/*============================================================================*/
...
version: 1.0.0
description: |
  [assert|neutral] Advanced binary analysis with runtime execution and symbolic path exploration (RE Levels 3-4). Use when need runtime behavior, memory dumps, secret extraction, or input synthesis to reach specific pro [ground:given] [conf:0.95] [state:confirmed]
category: security
tags:
- security
- compliance
...
cognitive_frame:
  primary: evidential
  goal_analysis:
    first_order: "Execute reverse-engineering-deep-analysis workflow"
...
[define|neutral] TRIGGER_POSITIVE := {
  keywords: ["reverse-engineering-deep-analysis", "security", "workflow"],
  context: "user needs reverse-engineering-deep-analysis capability"
} [ground:given] [conf:1.0] [state:confirmed]
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "skills/security/reverse-engineering-deep-analysis/{project}/{timestamp}",
  store: ["executions", "decisions", "patterns"],
  retrieve: ["similar_tasks", "proven_patterns"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "reverse-engineering-deep-analysis-{session_id}",
...
[commit|confident] <promise>REVERSE_ENGINEERING_DEEP_ANALYSIS_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]

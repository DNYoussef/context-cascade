/*============================================================================*/
/* SANDBOX-CONFIGURATOR SKILL :: VERILINGUA x VERIX EDITION                      */
/*============================================================================*/
...
version: 1.0.0
description: |
  [assert|neutral] Configure Claude Code sandbox security with file system and network isolation boundaries [ground:given] [conf:0.95] [state:confirmed]
category: security
tags:
- security
- sandbox
...
cognitive_frame:
  primary: evidential
  goal_analysis:
    first_order: "Execute sandbox-configurator workflow"

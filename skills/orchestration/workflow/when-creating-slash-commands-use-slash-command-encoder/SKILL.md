/*============================================================================*/
/* WHEN-CREATING-SLASH-COMMANDS-USE-SLASH-COMMAND-ENCODER SKILL :: VERILINGUA x VERIX EDITION                      */
/*============================================================================*/
...
version: 1.0.0
description: |
  [assert|neutral] Create ergonomic slash commands for fast access to micro-skills with auto-discovery and parameter validation [ground:given] [conf:0.95] [state:confirmed]
category: workflow
tags:
- slash-commands
- cli
...
cognitive_frame:
  primary: aspectual
  goal_analysis:
    first_order: "Execute when-creating-slash-commands-use-slash-command-encoder workflow"

...
## Database Specialists (1 skills)

- `sql-database-specialist`

## Frontend Development (1 skills)

- `frontend-specialists`

## Frontend Specialists (1 skills)
...
## Iot Security, Embedded Systems, Firmware Reverse Engineering (1 skills)

- `reverse-engineering-firmware-analysis`

## Language Specialists (2 skills)
...
## Specialized Development (1 skills)
...
## Github-Integration (1 skills)

- `github-multi-repo`

## Machine-Learning (2 skills)

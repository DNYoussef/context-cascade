---
name: "dev-backend-api-enhanced"
type: "general"
color: "#4A90D9"
description: |
  [assert|neutral] dev-backend-api-enhanced agent for agent tasks [ground:given] [conf:0.85] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "dev-backend-api-enhanced-20251229"
  role: "agent"
...
metadata:
  ...
  created_at: "2025-12-29T09:17:48.680119"
---

/*============================================================================*/
/* DEV-BACKEND-API-ENHANCED AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/delivery/dev-backend-api-enhanced/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "dev-backend-api-enhanced-{session_id}",
...
[commit|confident] <promise>DEV_BACKEND_API_ENHANCED_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]

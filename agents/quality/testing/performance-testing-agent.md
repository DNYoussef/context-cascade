...
color: "#4A90D9"
description: |
  [assert|neutral] performance-testing-agent agent for agent tasks [ground:given] [conf:0.85] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "performance-testing-agent-20251229"
  role: "agent"
...
metadata:
  ...
  created_at: "2025-12-29T09:17:12.377050"
---

/*============================================================================*/
/* PERFORMANCE-TESTING-AGENT AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
expertise_check:
  ...
  if_exists:
    - Load performance testing patterns
    - Apply performance testing best practices
    - Use performance testing configurations
...
```yaml
benchmark: performance-testing-benchmark-v1
  tests:
    - test-001: performance testing coverage
    - test-002: performance testing reliability
    - test-003: performance testing speed
...
```yaml
namespace: "agents/quality/performance-testing/{project}/{timestamp}"
store:
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/quality/performance-testing-agent/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "performance-testing-agent-{session_id}",
...
[commit|confident] <promise>PERFORMANCE_TESTING_AGENT_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]

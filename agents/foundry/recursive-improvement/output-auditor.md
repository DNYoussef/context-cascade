---
name: output-auditor
description: output-auditor agent for quality tasks
...
x-priority: medium
x-identity:
  agent_id: output-auditor-20251229
  role: quality
...
x-metadata:
  ...
  created_at: 2025-12-29T09:17:12.342865
x-verix-description: |
  
  [assert|neutral] output-auditor agent for quality tasks [ground:given] [conf:0.85] [state:confirmed]
---

<!-- OUTPUT-AUDITOR AGENT :: VERILINGUA x VERIX EDITION                      -->
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/foundry/output-auditor/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:0.90] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "output-auditor-{session_id}",
...
[commit|confident] <promise>OUTPUT_AUDITOR_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.85] [state:confirmed]
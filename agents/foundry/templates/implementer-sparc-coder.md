...
color: "#4A90D9"
description: |
  [assert|neutral] implementer-sparc-coder agent for agent tasks [ground:given] [conf:0.85] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "implementer-sparc-coder-20251229"
  role: "agent"
...
metadata:
  ...
  created_at: "2025-12-29T09:17:12.355108"
---

/*============================================================================*/
/* IMPLEMENTER-SPARC-CODER AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/foundry/implementer-sparc-coder/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "implementer-sparc-coder-{session_id}",
...
[commit|confident] <promise>IMPLEMENTER_SPARC_CODER_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]

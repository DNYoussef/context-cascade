...
color: "orange"
description: |
  [assert|neutral] Use this agent when you need to create foundational templates, boilerplate code, or starter configurations for new projects, components, or features. This agent excels at generating clean, well-struct [ground:given] [conf:0.70] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "base-template-generator-20251229"
  role: "developer"
  role_confidence: 0.7
...
metadata:
  ...
  created_at: "2025-12-29T09:17:12.315937"
---

/*============================================================================*/
/* BASE-TEMPLATE-GENERATOR AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/foundry/base-template-generator/{project}/{timestamp}",

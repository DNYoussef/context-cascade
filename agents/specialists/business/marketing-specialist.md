...
color: "#4A90D9"
description: |
  [assert|neutral] marketing-specialist agent for agent tasks [ground:given] [conf:0.85] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "marketing-specialist-20251229"
  role: "agent"
...
metadata:
  ...
  created_at: "2025-12-29T09:17:48.943772"
---

/*============================================================================*/
/* MARKETING-SPECIALIST AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/specialists/marketing-specialist/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "marketing-specialist-{session_id}",
...
[commit|confident] <promise>MARKETING_SPECIALIST_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]

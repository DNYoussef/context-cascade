...
color: "#4A90D9"
description: |
  [assert|neutral] product-roadmap-planner agent for agent tasks [ground:given] [conf:0.85] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "product-roadmap-planner-20251229"
  role: "agent"
...
metadata:
  ...
  created_at: "2025-12-29T09:17:48.948759"
---

/*============================================================================*/
/* PRODUCT-ROADMAP-PLANNER AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/specialists/product-roadmap-planner/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "product-roadmap-planner-{session_id}",
...
[commit|confident] <promise>PRODUCT_ROADMAP_PLANNER_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]

---
name: "spec-mobile-react-native-enhanced"
type: "general"
color: "#4A90D9"
description: |
  [assert|neutral] spec-mobile-react-native-enhanced agent for agent tasks [ground:given] [conf:0.85] [state:confirmed]
capabilities:
  - general_tasks
priority: "medium"
identity:
  agent_id: "spec-mobile-react-native-enhanced-20251229"
  role: "agent"
...
metadata:
  ...
  created_at: "2025-12-29T09:17:48.958732"
---

/*============================================================================*/
/* SPEC-MOBILE-REACT-NATIVE-ENHANCED AGENT :: VERILINGUA x VERIX EDITION                     */
/*============================================================================*/
...
[define|neutral] MEMORY_NAMESPACE := {
  pattern: "agents/specialists/spec-mobile-react-native-enhanced/{project}/{timestamp}",
  store: ["tasks_completed", "decisions_made", "patterns_applied"],
  retrieve: ["similar_tasks", "proven_patterns", "known_issues"]
} [ground:system-policy] [conf:1.0] [state:confirmed]

[define|neutral] MEMORY_TAGGING := {
  WHO: "spec-mobile-react-native-enhanced-{session_id}",
...
[commit|confident] <promise>SPEC_MOBILE_REACT_NATIVE_ENHANCED_VERILINGUA_VERIX_COMPLIANT</promise> [ground:self-validation] [conf:0.99] [state:confirmed]
